                    ...
                    <table style="background-color:white" class="table table-responsive table-bordered table-hover">
                        ...
                        <tr v-for="(val, index) in data.item">
                            ...
                            <td align="center">
                                ...
                                <button class="btn btn-info" v-on:click="attachmentPage(val.idItem, val.contentType)">
                                    <i class="fa fa-list"></i> Attachment
                                </button>
                            </td>
                        </tr>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            }, attachmentPage(id, type){
                this.$router.push("/attachment/list/" + id + "/" + type + "")
            },
            changePage (pageNum) {
